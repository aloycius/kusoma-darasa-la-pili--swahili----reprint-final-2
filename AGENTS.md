# Kusoma: Kitabu cha Mwanafunzi, Darasa la Pili — ADT Bundle Reference
...
```
KUSOMA-DARASA-LA-PILI--SWAHILI----Reprint-Final-2/
├── adt/                              # THE WEB APP
...
├── KUSOMA-DARASA-LA-PILI--SWAHILI----Reprint-Final-2.db                    # SQLite database (pipeline state)
├── KUSOMA-DARASA-LA-PILI--SWAHILI----Reprint-Final-2.pdf                   # Original source PDF
...
```json
{
  "title": "Kusoma: Kitabu cha Mwanafunzi, Darasa la Pili",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "sw"
...
| Original PDF | `KUSOMA-DARASA-LA-PILI--SWAHILI----Reprint-Final-2.pdf` |
| Pipeline database | `KUSOMA-DARASA-LA-PILI--SWAHILI----Reprint-Final-2.db` (SQLite) |
